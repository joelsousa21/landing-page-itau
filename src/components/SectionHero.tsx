...
export function SectionHero() {
  return (
    <section className="w-full h-[794px] bg-img_bg_hero bg-no-repeat bg-center bg-cover">
      <Container>
        <div className="flex-1 max-w-[500px]">
          ...
          <p className="text-white text-xl max-w-[408px] mb-8">
            Todas as operações que você precisa em um só lugar. Simples, com
            pleto e feito para você
          </p>
        ...
        <Image src={WomanImg} alt="Woman Image" className="mr-[-41px]" />
      </Container>
    </section>
  );
}
